...
namespace GradeComputation
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            static double calculateGrade(double sw1, double sw2, double qz1, double qz2, double assign, double lab, double exam)
            {
                // FOR MY EXAMPLE ONLY "HOW I WANT THE GRADE TO WORK": Seatworks (20%), Quizzes (20%), Assignment (10%), Lab (10%), Exam (40%)
